...
- (void) viewDidLoad {
    ...
    self.tableView = [[UITableView alloc] initWithFrame:frame style:[self getTableViewStyle]];
...
- (CGFloat) tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section
{
    ...
    if(sectionContent.titleHeight && sectionContent.titleHeight > 0)
    {
        return sectionContent.titleHeight;
    }
...
- (CGFloat) tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section
{
    ...
    if(sectionContent.footerHeight && sectionContent.footerHeight > 0)
    {
        return sectionContent.footerHeight;
    }
...
- (void) setHeaderText:(NSString *)headerTextValue {
	...
	if([self isViewLoaded]) {
		UIView *headerLabelContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, ScreenWidth, 0.0)];
...
- (void) setFooterText:(NSString *)footerTextValue {
	...
	if([self isViewLoaded]) {
		UIView *footerLabelContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, ScreenWidth, 0.0)];
